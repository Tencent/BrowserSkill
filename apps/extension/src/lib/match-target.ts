...
import type { CaptureGeometry, TargetDescriptorV3 } from "@/transport/types";
...
export function fallbackDescriptor(fallback?: CaptureTargetDescriptor): TargetDescriptorV3 {
  if (!fallback) {
...
export function matchTarget(input: MatchTargetInput): TargetDescriptorV3 {
